...
var G__23931 = cljs.core.drop.call(null,(2),sq);
var G__23932 = cljs.core.conj.call(null,v,c2);
sq = G__23931;
v = G__23932;
continue;
} else {
var G__23933 = cljs.core.drop.call(null,(2),sq);
var G__23934 = cljs.core.conj.call(null,v,c,c2);
sq = G__23933;
v = G__23934;
continue;
}
...
break;
case "\"":
var G__23935 = cljs.core.next.call(null,sq);
var G__23936 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__23935;
v = G__23936;
continue;
...
break;
default:
var G__23937 = cljs.core.next.call(null,sq);
var G__23938 = cljs.core.conj.call(null,v,c);
sq = G__23937;
v = G__23938;
continue;
...
while(true){
var G__23941 = (((instaparse.cfg.tag.call(null,tree) instanceof cljs.core.Keyword))?instaparse.cfg.tag.call(null,tree).fqn:null);
switch (G__23941) {
case "neg":
...
break;
case "rule":
var vec__23942 = instaparse.cfg.contents.call(null,tree);
var nt = cljs.core.nth.call(null,vec__23942,(0),null);
var alt_or_ord = cljs.core.nth.call(null,vec__23942,(1),null);
...
break;
case "paren":
var G__23944 = instaparse.cfg.content.call(null,tree);
tree = G__23944;
continue;
...
while(true){
var G__23946 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);
switch (G__23946) {
case "neg":
var G__23948 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23948;
continue;
...
break;
case "look":
var G__23949 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23949;
continue;
...
break;
case "rep":
var G__23950 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23950;
continue;

break;
case "star":
var G__23951 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23951;
continue;
...
break;
case "plus":
var G__23952 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23952;
continue;
...
break;
case "opt":
var G__23953 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__23953;
continue;
...
var valid_nts_23962 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));
var seq__23958_23963 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));
var chunk__23959_23964 = null;
var count__23960_23965 = (0);
var i__23961_23966 = (0);
while(true){
if((i__23961_23966 < count__23960_23965)){
var nt_23967 = cljs.core._nth.call(null,chunk__23959_23964,i__23961_23966);
if(cljs.core.truth_(valid_nts_23962.call(null,nt_23967))){
} else {
throw [cljs.core.str(cljs.core.subs.call(null,[cljs.core.str(nt_23967)].join(''),(1))),cljs.core.str(" occurs on the right-hand side of your grammar, but not on the left")].join('');
}

var G__23968 = seq__23958_23963;
var G__23969 = chunk__23959_23964;
var G__23970 = count__23960_23965;
var G__23971 = (i__23961_23966 + (1));
seq__23958_23963 = G__23968;
chunk__23959_23964 = G__23969;
count__23960_23965 = G__23970;
i__23961_23966 = G__23971;
continue;
} else {
var temp__4425__auto___23972 = cljs.core.seq.call(null,seq__23958_23963);
if(temp__4425__auto___23972){
var seq__23958_23973__$1 = temp__4425__auto___23972;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23958_23973__$1)){
var c__17898__auto___23974 = cljs.core.chunk_first.call(null,seq__23958_23973__$1);
var G__23975 = cljs.core.chunk_rest.call(null,seq__23958_23973__$1);
var G__23976 = c__17898__auto___23974;
var G__23977 = cljs.core.count.call(null,c__17898__auto___23974);
var G__23978 = (0);
seq__23958_23963 = G__23975;
chunk__23959_23964 = G__23976;
count__23960_23965 = G__23977;
i__23961_23966 = G__23978;
continue;
} else {
var nt_23979 = cljs.core.first.call(null,seq__23958_23973__$1);
if(cljs.core.truth_(valid_nts_23962.call(null,nt_23979))){
} else {
throw [cljs.core.str(cljs.core.subs.call(null,[cljs.core.str(nt_23979)].join(''),(1))),cljs.core.str(" occurs on the right-hand side of your grammar, but not on the left")].join('');
}

var G__23980 = cljs.core.next.call(null,seq__23958_23973__$1);
var G__23981 = null;
var G__23982 = (0);
var G__23983 = (0);
seq__23958_23963 = G__23980;
chunk__23959_23964 = G__23981;
count__23960_23965 = G__23982;
i__23961_23966 = G__23983;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR_23986_23988 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_23987_23989 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_23986_23988,_STAR_print_fn_STAR_23987_23989,sb__18069__auto__,rules){
return (function (x__18070__auto__){
return sb__18069__auto__.append(x__18070__auto__);
});})(_STAR_print_newline_STAR_23986_23988,_STAR_print_fn_STAR_23987_23989,sb__18069__auto__,rules))
;

try{cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_23987_23989;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_23986_23988;
}
...
if((rules instanceof instaparse.gll.Failure)){
throw [cljs.core.str("Error parsing grammar specification:\n"),cljs.core.str((function (){var sb__18069__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_23994_23998 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_23995_23999 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_23994_23998,_STAR_print_fn_STAR_23995_23999,sb__18069__auto__,rules){
return (function (x__18070__auto__){
return sb__18069__auto__.append(x__18070__auto__);
});})(_STAR_print_newline_STAR_23994_23998,_STAR_print_fn_STAR_23995_23999,sb__18069__auto__,rules))
;

try{cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_23995_23999;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_23994_23998;
}
return [cljs.core.str(sb__18069__auto__)].join('');
})())].join('');
} else {
...
throw [cljs.core.str("Error parsing grammar specification:\n"),cljs.core.str((function (){var sb__18069__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_23996_24000 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_23997_24001 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_23996_24000,_STAR_print_fn_STAR_23997_24001,sb__18069__auto__,rhs){
return (function (x__18070__auto__){
return sb__18069__auto__.append(x__18070__auto__);
});})(_STAR_print_newline_STAR_23996_24000,_STAR_print_fn_STAR_23997_24001,sb__18069__auto__,rhs))
;

try{cljs.core.println.call(null,rhs);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_23997_24001;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_23996_24000;
}
return [cljs.core.str(sb__18069__auto__)].join('');
})())].join('');
} else {
