...
var digit_19410 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_19411__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_19411__$1 > (0))){
var digit_19412__$1 = (digit_19410 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_19412__$1));

var G__19413 = (vlq_19411__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__19414 = (vlq_19411__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_19410 = G__19413;
vlq_19411__$1 = G__19414;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_19410));
}
break;
}
...
var G__19415 = i__$1;
var G__19416 = result__$1;
var G__19417 = shift__$1;
i = G__19415;
result = G__19416;
shift = G__19417;
continue;
