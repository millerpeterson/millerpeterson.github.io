...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17693__auto__,writer__17694__auto__,opt__17695__auto__){
return cljs.core._write.call(null,writer__17694__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__21696 = o;
(G__21696[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__21698__i < G__21698__a.length) {G__21698__a[G__21698__i] = arguments[G__21698__i + 0]; ++G__21698__i;}
  args = new cljs.core.IndexedSeq(G__21698__a,0);
} 
...
if(cljs.core.truth_((function (){var and__17083__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__17083__auto__){
var and__17083__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__17083__auto____$1){
var and__17083__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__21704 = jsprops;
(G__21704["defaultValue"] = value);

(G__21704["onChange"] = ((function (G__21704,v,value,on_change){
return (function (p1__21702_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21702_SHARP_);
});})(G__21704,v,value,on_change))
);
...
var vec__21709 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21709,(0),null);
var id = cljs.core.nth.call(null,vec__21709,(1),null);
var class$ = cljs.core.nth.call(null,vec__21709,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___21712 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___21712 == null)){
} else {
var key_21713 = temp__4429__auto___21712;
...
var G__21715 = (new reagent.impl.template.NativeWrapper());
(G__21715["name"] = c);
...
var len__18153__auto___21721 = arguments.length;
var i__18154__auto___21722 = (0);
while(true){
if((i__18154__auto___21722 < len__18153__auto___21721)){
args__18160__auto__.push((arguments[i__18154__auto___21722]));

var G__21723 = (i__18154__auto___21722 + (1));
i__18154__auto___21722 = G__21723;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__18161__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21719){
var G__21720 = cljs.core.first.call(null,seq21719);
var seq21719__$1 = cljs.core.next.call(null,seq21719);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21720,seq21719__$1);
});
...
break;
default:
var G__21727 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21727;
continue;
...
var n__17998__auto___21728 = a.length;
var i_21729 = (0);
while(true){
if((i_21729 < n__17998__auto___21728)){
(a[i_21729] = reagent.impl.template.as_element.call(null,(a[i_21729])));

var G__21730 = (i_21729 + (1));
i_21729 = G__21730;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17998__auto___21731 = a.length;
var i_21732 = (0);
while(true){
if((i_21732 < n__17998__auto___21731)){
var val_21733 = (a[i_21732]);
if((cljs.core.vector_QMARK_.call(null,val_21733)) && ((reagent.impl.template.key_from_vec.call(null,val_21733) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21732] = reagent.impl.template.as_element.call(null,val_21733));

var G__21734 = (i_21732 + (1));
i_21732 = G__21734;
continue;
} else {
}
...
var ctx = {};
var vec__21736 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21736,(0),null);
var derefed = cljs.core.nth.call(null,vec__21736,(1),null);
...
var G__21738 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21738) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21738){
