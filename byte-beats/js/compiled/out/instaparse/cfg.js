...
var G__24600 = cljs.core.drop.call(null,(2),sq);
var G__24601 = cljs.core.conj.call(null,v,c2);
sq = G__24600;
v = G__24601;
continue;
} else {
var G__24602 = cljs.core.drop.call(null,(2),sq);
var G__24603 = cljs.core.conj.call(null,v,c,c2);
sq = G__24602;
v = G__24603;
continue;
}
...
break;
case "\"":
var G__24604 = cljs.core.next.call(null,sq);
var G__24605 = cljs.core.conj.call(null,v,"\\","\"");
sq = G__24604;
v = G__24605;
continue;
...
break;
default:
var G__24606 = cljs.core.next.call(null,sq);
var G__24607 = cljs.core.conj.call(null,v,c);
sq = G__24606;
v = G__24607;
continue;
...
while(true){
var G__24610 = (((instaparse.cfg.tag.call(null,tree) instanceof cljs.core.Keyword))?instaparse.cfg.tag.call(null,tree).fqn:null);
switch (G__24610) {
case "neg":
...
break;
case "rule":
var vec__24611 = instaparse.cfg.contents.call(null,tree);
var nt = cljs.core.nth.call(null,vec__24611,(0),null);
var alt_or_ord = cljs.core.nth.call(null,vec__24611,(1),null);
...
break;
case "paren":
var G__24613 = instaparse.cfg.content.call(null,tree);
tree = G__24613;
continue;
...
while(true){
var G__24615 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser).fqn:null);
switch (G__24615) {
case "neg":
var G__24617 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24617;
continue;
...
break;
case "look":
var G__24618 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24618;
continue;
...
break;
case "rep":
var G__24619 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24619;
continue;

break;
case "star":
var G__24620 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24620;
continue;
...
break;
case "plus":
var G__24621 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24621;
continue;
...
break;
case "opt":
var G__24622 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24622;
continue;
...
var valid_nts_24631 = cljs.core.set.call(null,cljs.core.keys.call(null,grammar_map));
var seq__24627_24632 = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.mapcat.call(null,instaparse.cfg.seq_nt,cljs.core.vals.call(null,grammar_map))));
var chunk__24628_24633 = null;
var count__24629_24634 = (0);
var i__24630_24635 = (0);
while(true){
if((i__24630_24635 < count__24629_24634)){
var nt_24636 = cljs.core._nth.call(null,chunk__24628_24633,i__24630_24635);
if(cljs.core.truth_(valid_nts_24631.call(null,nt_24636))){
} else {
throw [cljs.core.str(cljs.core.subs.call(null,[cljs.core.str(nt_24636)].join(''),(1))),cljs.core.str(" occurs on the right-hand side of your grammar, but not on the left")].join('');
}

var G__24637 = seq__24627_24632;
var G__24638 = chunk__24628_24633;
var G__24639 = count__24629_24634;
var G__24640 = (i__24630_24635 + (1));
seq__24627_24632 = G__24637;
chunk__24628_24633 = G__24638;
count__24629_24634 = G__24639;
i__24630_24635 = G__24640;
continue;
} else {
var temp__4425__auto___24641 = cljs.core.seq.call(null,seq__24627_24632);
if(temp__4425__auto___24641){
var seq__24627_24642__$1 = temp__4425__auto___24641;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24627_24642__$1)){
var c__17655__auto___24643 = cljs.core.chunk_first.call(null,seq__24627_24642__$1);
var G__24644 = cljs.core.chunk_rest.call(null,seq__24627_24642__$1);
var G__24645 = c__17655__auto___24643;
var G__24646 = cljs.core.count.call(null,c__17655__auto___24643);
var G__24647 = (0);
seq__24627_24632 = G__24644;
chunk__24628_24633 = G__24645;
count__24629_24634 = G__24646;
i__24630_24635 = G__24647;
continue;
} else {
var nt_24648 = cljs.core.first.call(null,seq__24627_24642__$1);
if(cljs.core.truth_(valid_nts_24631.call(null,nt_24648))){
} else {
throw [cljs.core.str(cljs.core.subs.call(null,[cljs.core.str(nt_24648)].join(''),(1))),cljs.core.str(" occurs on the right-hand side of your grammar, but not on the left")].join('');
}

var G__24649 = cljs.core.next.call(null,seq__24627_24642__$1);
var G__24650 = null;
var G__24651 = (0);
var G__24652 = (0);
seq__24627_24632 = G__24649;
chunk__24628_24633 = G__24650;
count__24629_24634 = G__24651;
i__24630_24635 = G__24652;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR_24655_24657 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_24656_24658 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_24655_24657,_STAR_print_fn_STAR_24656_24658,sb__17826__auto__,rules){
return (function (x__17827__auto__){
return sb__17826__auto__.append(x__17827__auto__);
});})(_STAR_print_newline_STAR_24655_24657,_STAR_print_fn_STAR_24656_24658,sb__17826__auto__,rules))
;

try{cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24656_24658;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_24655_24657;
}
...
if((rules instanceof instaparse.gll.Failure)){
throw [cljs.core.str("Error parsing grammar specification:\n"),cljs.core.str((function (){var sb__17826__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_24663_24667 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_24664_24668 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_24663_24667,_STAR_print_fn_STAR_24664_24668,sb__17826__auto__,rules){
return (function (x__17827__auto__){
return sb__17826__auto__.append(x__17827__auto__);
});})(_STAR_print_newline_STAR_24663_24667,_STAR_print_fn_STAR_24664_24668,sb__17826__auto__,rules))
;

try{cljs.core.println.call(null,rules);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24664_24668;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_24663_24667;
}
return [cljs.core.str(sb__17826__auto__)].join('');
})())].join('');
} else {
...
throw [cljs.core.str("Error parsing grammar specification:\n"),cljs.core.str((function (){var sb__17826__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_24665_24669 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_24666_24670 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_24665_24669,_STAR_print_fn_STAR_24666_24670,sb__17826__auto__,rhs){
return (function (x__17827__auto__){
return sb__17826__auto__.append(x__17827__auto__);
});})(_STAR_print_newline_STAR_24665_24669,_STAR_print_fn_STAR_24666_24670,sb__17826__auto__,rhs))
;

try{cljs.core.println.call(null,rhs);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24666_24670;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_24665_24669;
}
return [cljs.core.str(sb__17826__auto__)].join('');
})())].join('');
} else {
...
//# sourceMappingURL=cfg.js.map?rel=1455043063645