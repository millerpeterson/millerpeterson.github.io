...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17494__auto__,writer__17495__auto__,opt__17496__auto__){
return cljs.core._write.call(null,writer__17495__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__18365 = o;
(G__18365[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__16884__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__16884__auto__){
var and__16884__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16884__auto____$1){
var and__16884__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__16884__auto____$2)){
return (jsprops["hasOwnProperty"])("value");
} else {
return and__16884__auto____$2;
}
} else {
return and__16884__auto____$1;
}
} else {
...
var G__18373 = jsprops;
(G__18373["defaultValue"] = value);

(G__18373["onChange"] = ((function (G__18373,v,value,on_change){
return (function (p1__18371_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18371_SHARP_);
});})(G__18373,v,value,on_change))
);
...
var vec__18378 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18378,(0),null);
var id = cljs.core.nth.call(null,vec__18378,(1),null);
var class$ = cljs.core.nth.call(null,vec__18378,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___18381 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___18381 == null)){
} else {
var key_18382 = temp__4429__auto___18381;
(jsprops["key"] = key_18382);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18384 = (new reagent.impl.template.NativeWrapper());
(G__18384["name"] = c);
...
var len__17954__auto___18390 = arguments.length;
var i__17955__auto___18391 = (0);
while(true){
if((i__17955__auto___18391 < len__17954__auto___18390)){
args__17961__auto__.push((arguments[i__17955__auto___18391]));

var G__18392 = (i__17955__auto___18391 + (1));
i__17955__auto___18391 = G__18392;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17962__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18388){
var G__18389 = cljs.core.first.call(null,seq18388);
var seq18388__$1 = cljs.core.next.call(null,seq18388);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18389,seq18388__$1);
});
...
break;
default:
var G__18396 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__18396;
continue;
...
var n__17799__auto___18397 = a.length;
var i_18398 = (0);
while(true){
if((i_18398 < n__17799__auto___18397)){
(a[i_18398] = reagent.impl.template.as_element.call(null,(a[i_18398])));
...
var a = cljs.core.into_array.call(null,s);
var n__17799__auto___18400 = a.length;
var i_18401 = (0);
while(true){
if((i_18401 < n__17799__auto___18400)){
var val_18402 = (a[i_18401]);
if((cljs.core.vector_QMARK_.call(null,val_18402)) && ((reagent.impl.template.key_from_vec.call(null,val_18402) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18401] = reagent.impl.template.as_element.call(null,val_18402));

var G__18403 = (i_18401 + (1));
i_18401 = G__18403;
continue;
} else {
}
...
var ctx = {};
var vec__18405 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18405,(0),null);
var derefed = cljs.core.nth.call(null,vec__18405,(1),null);
...
var G__18407 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18407) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__18407){
...
//# sourceMappingURL=template.js.map?rel=1466538814640